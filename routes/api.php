...
use App\Http\Controllers\RentOwnerController;
...
Route::group(['prefix' => 'auth', 'middleware' => 'auth:api'], function(){
    ...
    Route::apiResource('rent-owner', RentOwnerController::class);
    Route::apiResource('rent-payment', RentPaymentController::class);
    Route::apiResource('monthly-payment', MonthlyPaymentController::class);
