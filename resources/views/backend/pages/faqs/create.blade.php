                    ...
                    <form action="{{ route('admin.faqs.store') }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 col-sm-12">
                                ...
                                <input name="question" type="text" class="form-control" id="name" name="name" placeholder="Enter Question">
                            </div>
                            <div class="form-group col-md-12 col-sm-12">
                                <label for="email">Answer</label>
                               <textarea name="answer" class="form-control" name="" id="" cols="30" rows="10"></textarea>
                            </div>
                        </div>
